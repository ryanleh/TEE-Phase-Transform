...
class UndetectableMimikatzReporter(object):
  ...
  def cred_already_printed(self, username, pwd, domain, cred_type):
    return any([printed_obj['cred_type'] == cred_type and printed_obj['username'] == username and printed_obj['pwd'] == pwd and printed_obj['domain'] == domain for printed_obj in self.printed_objects])
