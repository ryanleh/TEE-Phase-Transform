...
class CounterClass(object):
    ...
    def Dump(self):
        print('CountId:{0} CounterName:{1} Description:{2} Count:{3} Time:{4} Data0:{5} Data1:{6}'.format(self.CounterId, self.CounterName, self.Description, self.Count, self.Time, self.Data0, self.Data1))
