...
class TestWPUndetectableMimikatzAgent(unittest.TestCase):

    def setUp(self):
        AiLoggerClass().Enable()
    
    def test_check_agent_success_with_valid_output(self):
        agent = UndetectableMimikatzAgent()
    ...
    def test_process_mimikatz_command_output_with_user_and_cred_types(self):
        phase = UndetectableMimikatzAgent(cred_types=['ntlm', 'cleartext'], usernames=['Administrator', 'WIN-H7MK73PJ720$'])
