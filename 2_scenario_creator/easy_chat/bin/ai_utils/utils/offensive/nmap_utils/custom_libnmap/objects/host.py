...
from ai_utils.utils.offensive.nmap_utils.custom_libnmap.diff import NmapDiff
from ai_utils.utils.offensive.nmap_utils.custom_libnmap.objects.os import NmapOSFingerprint
