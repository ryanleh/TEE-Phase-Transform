...
class NmapProcess(Thread):
    ...
    def __init__(self, targets="127.0.0.1",
        ...
        if self.__nmap_binary is None:
            raise EnvironmentError(1, "nmap binary not defined. nmap is not installed or could "
    ...
    def run(self):
        ...
        try:
            ...
            raise EnvironmentError(1, "An error occurred executing nmap. Error: {}".format(e))
