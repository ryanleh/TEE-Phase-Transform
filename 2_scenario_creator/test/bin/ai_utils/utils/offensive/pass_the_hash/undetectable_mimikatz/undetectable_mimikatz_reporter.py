...
class UndetectableMimikatzReporter(object):

  def __init__(self, username, target_machine_with_fqdn, fqdn, phase_reporter=None):
    logging.debug('Executing UndetectableMimikatzReporter constructor. username: {}, target_machine_with_fqdn: {}, fqdn: {}, phase_reporter: {}'.format(username, target_machine_with_fqdn, fqdn, phase_reporter))
