...
import circadence_phases.tcp_connect
import circadence_phases.host_discovery
import importlib
import logging

class testScenarioClass(AbstractScenarioClass):
    TrackerId = "9d93cefb-a280-4d2e-ade3-3dd976a78d96"
    Subject = "test"
    Description = """"""
    ...
    def __init__(self, model):
        ...
        self._state = model
        self.phases = """tcp_connect
host_discovery""".split()
...
if __name__ == "__main__":
    ...
    # Append ai_utils directory to python path
    sys.path.append('./bin')
    run()
